...
void HelloTriangleApplication::createInstance() {
    ...
    // set instance creation & destruction debug massage
...
std::vector<const char *> HelloTriangleApplication::getRequiredExtensions() const {
    ...
    glfwExtensions = glfwGetRequiredInstanceExtensions(&glfwExtensionCount); // glfw extensions are always be required

    std::vector<const char*> extensions(glfwExtensions, glfwExtensions + glfwExtensionCount);

    // if enable validation lay, add debug utils extension
    if (enableValidationLayers) {
...
void HelloTriangleApplication::createGraphicsPipeline() {
    std::vector<char> vertShaderCode = readFile("spv/vert.spv");
    std::vector<char> fragShaderCode = readFile("spv/frag.spv");
